            ...
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/billet/ajout_billet"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>

                        <h5 class="card-title fw-semibold mb-4">Liste de billets</h5>
                                      ...
                                      <thead class="text-dark fs-4">
                                        <tr>
                                            <th class="border-bottom-0">
                                              ...
                                              <th class="border-bottom-0">
                                                <h6 class="fw-semibold mb-0">Voyage</h6>
                                              </th>
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Voyageur</h6>
                                          </th>
                                          <th class="border-bottom-0">
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <button class="btn btn-success">
                                             <a href="/billet/modifier_billet" target="_blank" rel="noopener noreferrer">
