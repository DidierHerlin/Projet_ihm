        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              ...
              <div class="card">
                <div class="card-body">
                    <form action="{{ route('modifierRecette', ['id' => $recettes->id]) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <div class="mb-3">

                            <input type="hidden" class="form-control" id="date_recette" name="id" value="{{$recettes->id}}">
                        </div>
                        ...
                        <select class="form-select" id="vehicule_id" name="vehicule_id"
                            ...
                            @isset($vehicules)
                                @foreach ($vehicules as $vehicules)
                                   <option value="{{ $vehicules->id}}"{{ $vehicules->id == $vehicules->id ? 'selected' : '' }}>{{ $vehicules->immatricule }}</option>                                @endforeach
                            @endisset
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="mb-3">
                            <label for="date_recette" class="form-label">Date de recette</label>
                            <input type="date" class="form-control" id="date_recette" name="date_recette" value="{{$recettes->date_recette}}">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1"
                            name="montant_recette" value="{{$recettes->montant_recette}}">
                    </div>
