        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title fw-semibold mb-4">Ajout recettes</h5>
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('ajoutRecette') }}" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="date_recette" name="date_recette">
                                            </div>
