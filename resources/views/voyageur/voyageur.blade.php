            ...
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/voyageur/ajout_voyageur"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>

                        <h5 class="card-title fw-semibold mb-4">Liste de voyageur</h5>
                        <div class="table-responsive">
                                ...
                                <!-- Le contenu de votre tableau ici -->
                                    ...
                                    @foreach($voyageurs as $voyageurs)
                                      <tbody>
                                        <tr>
                                          <td>{{$voyageurs->nom_voyageur}}</td>
                                          <td>{{$voyageurs->tel_voyageur}}</td>
                                          <td>{{$voyageurs->adresse_voyageur}}</td>


                                          <td>
                                            <button class="btn btn-success">
                                             <a href="{{ route('editVoyageur', ['id' => $voyageurs->id]) }}" target="_blank" rel="noopener noreferrer">
                                          ...
                                          <form id="deleteForm" action="{{route('supVoyageur',$voyageurs->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
