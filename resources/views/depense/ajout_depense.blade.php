    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Ajout depense</h5>
              <div class="card">
                <div class="card-body">
                  <form action="{{route('ajourDepenses')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Date</label>
                      <input type="date" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="date_depense">
                    </div>
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="id_vehicule" name="id_vehicule"
                            ...
                            @isset($vehicules)
                                @foreach ($vehicules as $vehicules)
                                    <option value="{{ $vehicules->id }}">{{ $vehicules->immatricule }}
                                    </option>
                                @endforeach
                            @endisset
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="exampleSelect" name="type_depense">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputPassword1" name="montant_depense">
                      </div>
