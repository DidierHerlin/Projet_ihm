        ...
        <div class="row">
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/depense/ajout_depense"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>

                        <h5 class="card-title fw-semibold mb-4">Liste de depenses</h5>
                                ...
                                <!-- Le contenu de votre tableau ici -->
                                    ...
                                    @foreach($depenses as $depenses)
                                        <tr>
                                          ...
                                          <td>{{$depenses->date_depense}}</td>
                                          <td>{{$depenses->nom_conducteur}}</td>
                                          <td>{{$depenses->immatricule}}</td>
                                          <td>{{$depenses->type_depense}}</td>
                                          <td>{{$depenses->montant_depense}}</td>
                                          <td></td>
                                          <td>
                                            <button class="btn btn-success">
                                             <a href="/depense/modifier_depense/{{$depenses->id}}" target="_blank" rel="noopener noreferrer">
                                          ...
                                          <form id="deleteForm" action="{{route('supDepense',$depenses->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
