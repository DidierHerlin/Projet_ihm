            ...
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/voyage/ajout_voyage"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>

                        <h5 class="card-title fw-semibold mb-4">Liste de voyage</h5>
                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                      <thead class="text-dark fs-4">
                                        <tr>
                                          ...
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Trajet</h6>
                                          </th>
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Nombre de voyageur</h6>
                                          </th>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td>{{$voyages->date_voyage}}</td>
                                          <td>{{$voyages->nom_conducteur}} </td>
                                          <td>{{$voyages->immatricule}}</td>
                                          <td>{{$voyages->ville_depart. '-'.$voyages->ville_arriver}}</td>
                                          <td>{{$voyages->nombre_voageur}}</td>
                                          <td>
                                            <button class="btn btn-success">
                                             <a href="/voyage/modifier_voyage/{{$voyages->id}}" target="_blank" rel="noopener noreferrer">
                                          ...
                                          <form id="deleteForm" action="{{route('supprimerVoyage',$voyages->id)}}" method="POST">
                                            @csrf
                                            @method('DELETE')
