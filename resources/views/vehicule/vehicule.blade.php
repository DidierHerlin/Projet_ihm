            ...
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/vehicule/ajout_vehicule"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>

                        <h5 class="card-title fw-semibold mb-4">Liste de véhicule</h5>
                                ...
                                <!-- Le contenu de votre tableau ici -->
                                    ...
                                    <table class="table text-nowrap mb-0 align-middle">
                                      <thead class="text-dark fs-4">
                                        <tr>
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Immatricule</h6>
                                          </th>
                                          <th class="border-bottom-0">
                                          ...
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Places</h6>
                                          </th>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>{{$vehicules->immatricule}}</td>
                                          <td>{{$vehicules->marque}}</td>
                                          <td>{{$vehicules->modele}}</td>
                                          <td>{{$vehicules->nbr_place}}</td>
                                          <td>
                                            <button class="btn btn-success">
                                                <a href="/vehicule/modifier_vehicule/{{ $vehicules->id }}" target="_blank" rel="noopener noreferrer">
                                                ...
                                                <form id="deleteForm" action="{{route('supVeh',$vehicules->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
