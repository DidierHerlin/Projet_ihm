            ...
            <div class="col-12">
                <div class="card w-100">
                    <div class="card-body p-4">
                      <a href="/trajet/ajout_trajet"><button type="button" class="btn btn-primary m-1">Ajouter</button></a>
                        <h5 class="card-title fw-semibold mb-4">Liste de trajet</h5>
                        <div class="table-responsive">
                                <!-- Le contenu de votre tableau ici -->
                                    <table class="table text-nowrap mb-0 align-middle">
                                      <thead class="text-dark fs-4">
                                        ...
                                        <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Départ</h6>
                                        </th>
                                          <th class="border-bottom-0">
                                            <h6 class="fw-semibold mb-0">Arriver</h6>
                                          </th>
                                          <th class="border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$trajets->ville_depart}}</td>
                                        <td>{{$trajets->ville_arriver}}</td>
                                        <td>{{$trajets->distance}}KM</td>
                                        <td>{{$trajets->montant_trajet}}AR</td>

                                        <td>
                                            <button class="btn btn-success">
                                                <a href="/trajet/modifier_trajet/{{ $trajets->id }}" target="_blank" rel="noopener noreferrer">
                                                ...
                                                <form id="deleteForm"  action="{{route('supTrajet',$trajets->id)}}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
