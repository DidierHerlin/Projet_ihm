    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Ajout trajet</h5>
              <div class="card">
                <div class="card-body">
                    <form class="form-sample" action="{{ route('ajoutTrajet') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="ville_arriver" class="form-label">Arrivée</label>
                            <input type="text" class="form-control" id="ville_arriver" name="ville_arriver" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="montant_trajet" name="montant_trajet" required>
                        </div>
