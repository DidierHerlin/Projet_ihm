    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4">Ajout conducteur</h5>
              <div class="card">
                <div class="card-body">
                    <form class="form-sample" action="{{ route('store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cin" name="cin" aria-describedby="cinHelp" required>
                        </div>
                        <div class="mb-3">
                            <label for="nom_conduct" class="form-label">Nom</label>
                            <input type="text" class="form-control" id="nom_conduct" name="nom_conducteur" required>
                        </div>
                        <div class="mb-3">
                            <label for="tel_conduct" class="form-label">Téléphone</label>
